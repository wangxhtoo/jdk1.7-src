...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E> {
	 ...
	 * iterates over it, inserting the elements obtained from the iterator into this
	 * list at the appropriate position, one at a time, using {@code add(int, E)}.
	 ...
	 * interface, relying on the backing list's {@code size()}, {@code get(int)},
	 ...
	 *
	 * <p>
	 * This implementation gets a list iterator positioned before {@code fromIndex},
	 * and repeatedly calls {@code ListIterator.next} followed by
	 * {@code ListIterator.remove} until the entire range has been removed. <b>Note:
	 * if {@code ListIterator.remove} requires linear time, this implementation
	 * requires quadratic time.</b>
	 *
