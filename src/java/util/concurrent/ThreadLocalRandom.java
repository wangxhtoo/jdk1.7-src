...
public class ThreadLocalRandom extends Random {
	 ...
	 * constructor. We can't allow others since it would cause setting seed in one part of a program to
	...
	/**
	 * Returns a pseudorandom, uniformly distributed value between the given least value (inclusive) and
	 * bound (exclusive).
	 *
	...
	/**
	 * Returns a pseudorandom, uniformly distributed value between 0 (inclusive) and the specified value
	 * (exclusive).
	 *
	...
	/**
	 * Returns a pseudorandom, uniformly distributed {@code double} value between 0 (inclusive) and the
